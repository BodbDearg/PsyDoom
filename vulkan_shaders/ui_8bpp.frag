...
// Does texture mapping (@8bpp) with clamp to texture window, coloring and adjustments for blending.
//----------------------------------------------------------------------------------------------------------------------
...
void main() {
    out_color = tex8bpp(vramTex, ivec2(floor(in_uv)), in_texWinPos, in_texWinSize, in_clutPos, in_stmul, false, true);
