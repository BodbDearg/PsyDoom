...
class V810
{
 ...
 #ifdef WANT_DEBUGGER
 NO_INLINE void Run_Fast_Debug(int32 MDFN_FASTCALL (*event_handler)(const v810_timestamp_t timestamp));
 NO_INLINE void Run_Accurate_Debug(int32 MDFN_FASTCALL (*event_handler)(const v810_timestamp_t timestamp));
 #endif
