...
static const ProgElem ELEMS[] = {
    ...
    { 0x800670F4, 0x8006710C, "WEAPON_INFO_FIST",                   ProgElemType::ARRAY, ProgElemType::UINT32, 0 },
    { 0x8006710C, 0x80067124, "WEAPON_INFO_PISTOL",                 ProgElemType::ARRAY, ProgElemType::UINT32, 0 },
    { 0x80067124, 0x8006713C, "WEAPON_INFO_SHOTGUN",                ProgElemType::ARRAY, ProgElemType::UINT32, 0 },
    { 0x8006713C, 0x80067154, "WEAPON_INFO_SUPER_SHOTGUN",          ProgElemType::ARRAY, ProgElemType::UINT32, 0 },
    { 0x80067154, 0x8006716C, "WEAPON_INFO_CHAINGUN",               ProgElemType::ARRAY, ProgElemType::UINT32, 0 },
    { 0x8006716C, 0x80067184, "WEAPON_INFO_ROCKET_LAUNCHER",        ProgElemType::ARRAY, ProgElemType::UINT32, 0 },
    { 0x80067184, 0x8006719C, "WEAPON_INFO_PLASMA_RIFLE",           ProgElemType::ARRAY, ProgElemType::UINT32, 0 },
    { 0x8006719C, 0x800671B4, "WEAPON_INFO_BFG",                    ProgElemType::ARRAY, ProgElemType::UINT32, 0 },
    { 0x800671B4, 0x800671CC, "WEAPON_INFO_CHAINSAW",               ProgElemType::ARRAY, ProgElemType::UINT32, 0 },
