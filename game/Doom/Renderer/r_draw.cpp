...
void R_DrawSubsector(subsector_t& subsec) noexcept {
    ...
    //
    // PC-PSX: use global memory instead, can hold a lot more!
    #if PC_PSX_DOOM_MODS
...
int32_t R_CheckLeafSide(const bool bRightViewPlane, const leaf_t& leaf) noexcept {
    ...
    // PC-PSX: use global memory instead, can hold a lot more! Also use normal bool.
    #if PC_PSX_DOOM_MODS
