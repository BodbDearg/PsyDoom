...
// 2nd sector flag bit - 'SF_GHOSTPLAT'. This new meaning can cause unintended bugs where floors render lower than they should for original
// game maps. Hence we must clear all sector flag bits (other than the 1st) for original game maps.
//------------------------------------------------------------------------------------------------------------------------------------------
