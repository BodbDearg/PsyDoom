...
static void addMaps_GEC_ME_Beta3(std::vector<Map>& maps) noexcept {
    ...
    addMap(maps, 31, 2, "Titan Manor",              1,    SPU_REV_MODE_SPACE,     0x0FFF);
    addMap(maps, 32, 2, "Trapped On Titan",         9,    SPU_REV_MODE_STUDIO_C,  0x2FFF);
    addMap(maps, 33, 2, "The Garrison",             14,   SPU_REV_MODE_HALL,      0x1FFF);
    addMap(maps, 34, 2, "Black Tower",              12,   SPU_REV_MODE_HALL,      0x1FFF);
    addMap(maps, 35, 2, "Bloodsea Keep",            8,    SPU_REV_MODE_STUDIO_B,  0x2DFF);
    addMap(maps, 36, 2, "TEETH",                    13,   SPU_REV_MODE_SPACE,     0x0FFF);
    addMap(maps, 37, 2, "The Titan Anomaly",        18,   SPU_REV_MODE_SPACE,     0x0FFF);
    addMap(maps, 38, 2, "The Farside Of Titan",     20,   SPU_REV_MODE_STUDIO_C,  0x2FFF);
    addMap(maps, 39, 2, "Dantes Gate",              15,   SPU_REV_MODE_STUDIO_B,  0x27FF);
    addMap(maps, 40, 2, "Crossing Acheron",         19,   SPU_REV_MODE_HALL,      0x1FFF);
    addMap(maps, 41, 2, "The Hive!",                11,   SPU_REV_MODE_HALL,      0x1FFF);
    addMap(maps, 42, 2, "The D.M.Z.",               16,   SPU_REV_MODE_HALL,      0x1FFF);
    addMap(maps, 43, 2, "The C.P.U",                12,   SPU_REV_MODE_HALL,      0x1FFF);
    addMap(maps, 44, 2, "The Fury",                 17,   SPU_REV_MODE_STUDIO_C,  0x2FFF);
    addMap(maps, 45, 2, "The Enemy Inside",         6,    SPU_REV_MODE_HALL,      0x1FFF);
    addMap(maps, 46, 2, "Device One",               5,    SPU_REV_MODE_STUDIO_C,  0x2FFF);
    addMap(maps, 47, 2, "Bloodflood",               9,    SPU_REV_MODE_STUDIO_C,  0x2FFF);
    addMap(maps, 48, 2, "Derelict Station",         2,    SPU_REV_MODE_HALL,      0x1FFF);
    addMap(maps, 49, 2, "The Image of Evil",        3,    SPU_REV_MODE_STUDIO_B,  0x27FF);
    addMap(maps, 50, 2, "Bad Dream",                1,    SPU_REV_MODE_STUDIO_C,  0x2FFF);
    // TNT
    addMap(maps, 51, 3, "Power Control",            7,    SPU_REV_MODE_STUDIO_C,  0x26FF);
    addMap(maps, 52, 3, "Hanger",                   8,    SPU_REV_MODE_STUDIO_B,  0x2DFF);
    addMap(maps, 53, 3, "Open Season",              15,   SPU_REV_MODE_STUDIO_B,  0x27FF);
    addMap(maps, 54, 3, "Prison",                   4,    SPU_REV_MODE_HALL,      0x17FF);
    addMap(maps, 55, 3, "Metal",                    17,   SPU_REV_MODE_HALL,      0x1FFF);
    addMap(maps, 56, 3, "Stronghold",               18,   SPU_REV_MODE_SPACE,     0x0FFF);
    addMap(maps, 57, 3, "Redemption",               10,   SPU_REV_MODE_SPACE,     0x0FFF);
    addMap(maps, 58, 3, "Storage Facility",         16,   SPU_REV_MODE_SPACE,     0x0FFF);
    addMap(maps, 59, 3, "Steel Works",              13,   SPU_REV_MODE_SPACE,     0x0FFF);
    addMap(maps, 60, 3, "Dead Zone",                17,   SPU_REV_MODE_HALL,      0x1FFF);
    addMap(maps, 61, 3, "Mill",                     18,   SPU_REV_MODE_SPACE,     0x0FFF);
    addMap(maps, 62, 3, "Shipping Respawning",      10,   SPU_REV_MODE_SPACE,     0x0FFF);
    addMap(maps, 63, 3, "Central Processing",       16,   SPU_REV_MODE_SPACE,     0x0FFF);
    addMap(maps, 64, 3, "Administration Center",    13,   SPU_REV_MODE_SPACE,     0x0FFF);
    addMap(maps, 65, 3, "Habitat",                  17,   SPU_REV_MODE_HALL,      0x1FFF);
    addMap(maps, 66, 3, "Barons Den",               18,   SPU_REV_MODE_SPACE,     0x0FFF);
    addMap(maps, 67, 3, "Mount Pain",               10,   SPU_REV_MODE_SPACE,     0x0FFF);
    addMap(maps, 68, 3, "River Styx",               16,   SPU_REV_MODE_SPACE,     0x0FFF);
    addMap(maps, 69, 3, "Pharaoh",                  13,   SPU_REV_MODE_SPACE,     0x0FFF);
    addMap(maps, 70, 3, "Caribbean",                17,   SPU_REV_MODE_HALL,      0x1FFF);
    // Plutonia
    addMap(maps, 71, 4, "Well Of Souls",            18,   SPU_REV_MODE_SPACE,     0x0FFF);
    addMap(maps, 72, 4, "Caged",                    10,   SPU_REV_MODE_SPACE,     0x0FFF);
    addMap(maps, 73, 4, "Caughtyard",               16,   SPU_REV_MODE_SPACE,     0x0FFF);
    addMap(maps, 74, 4, "Abattoire",                13,   SPU_REV_MODE_SPACE,     0x0FFF);
    addMap(maps, 75, 4, "Hunted",                   17,   SPU_REV_MODE_HALL,      0x1FFF);
    addMap(maps, 76, 4, "Speed",                    18,   SPU_REV_MODE_SPACE,     0x0FFF);
    addMap(maps, 77, 4, "The Crypt",                10,   SPU_REV_MODE_SPACE,     0x0FFF);
    addMap(maps, 78, 4, "Genesis",                  16,   SPU_REV_MODE_SPACE,     0x0FFF);
    addMap(maps, 79, 4, "The Twilight",             13,   SPU_REV_MODE_SPACE,     0x0FFF);
    addMap(maps, 80, 4, "The Omen",                 17,   SPU_REV_MODE_HALL,      0x1FFF);
    addMap(maps, 81, 4, "Compound",                 18,   SPU_REV_MODE_SPACE,     0x0FFF);
    addMap(maps, 82, 4, "Neurosphere",              10,   SPU_REV_MODE_SPACE,     0x0FFF);
    addMap(maps, 83, 4, "N-M-E",                    16,   SPU_REV_MODE_SPACE,     0x0FFF);
    addMap(maps, 84, 4, "Slayer",                   13,   SPU_REV_MODE_SPACE,     0x0FFF);
    addMap(maps, 85, 4, "Impossible Mission",       17,   SPU_REV_MODE_HALL,      0x1FFF);
    addMap(maps, 86, 4, "Tombstone",                18,   SPU_REV_MODE_SPACE,     0x0FFF);
    addMap(maps, 87, 4, "The Final Frontier",       10,   SPU_REV_MODE_SPACE,     0x0FFF);
    addMap(maps, 88, 4, "The Temple Of Darkness",   16,   SPU_REV_MODE_SPACE,     0x0FFF);
    addMap(maps, 89, 4, "Bunker",                   13,   SPU_REV_MODE_SPACE,     0x0FFF);
    addMap(maps, 90, 4, "Anti-Christ",              17,   SPU_REV_MODE_HALL,      0x1FFF);
    addMap(maps, 91, 4, "The Sewers",               18,   SPU_REV_MODE_SPACE,     0x0FFF);
    addMap(maps, 92, 4, "Odyssey of Noises",        10,   SPU_REV_MODE_SPACE,     0x0FFF);
    addMap(maps, 93, 4, "Cyberden",                 16,   SPU_REV_MODE_SPACE,     0x0FFF);
    addMap(maps, 94, 4, "Go 2 It",                  13,   SPU_REV_MODE_SPACE,     0x0FFF);
}
