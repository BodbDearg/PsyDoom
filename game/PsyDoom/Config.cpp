...
static const ConfigFieldHandler GAME_CFG_INI_HANDLERS[] = {
    ...
    },
    {
        ...
        "#\n"
        "# Sectors:     Whether sector floor or ceiling motion is smoothed. Also causes objects pushed by\n"
        "#              ceilings or floors to have that motion smoothed too, if enabled.\n"
