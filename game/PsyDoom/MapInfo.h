...
struct GameInfo {
    ...
    uint8_t             texPalette_DATA;            // Palette index to use for the 'DATA' image lump
    uint8_t             texPalette_FINAL;           // Palette index to use for the 'FINAL' image lump
